...
const Profile = () => {
  ...
  const [bio, setBio] = useState("Software Engineer with 5 years of experience in web development.");
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-white via-secondary/10 to-white">
      <Helmet>
        ...
        <meta name="description" content="View and manage your Interviewly profile." />
      </Helmet>
            ...
            <div className="md:w-2/3 space-y-4">
              ...
              <div className="space-y-2">
                ...
                <textarea
                  ...
                  readOnly={!isEditing}
                  className={`flex h-24 w-full rounded-md border border-input bg-background px-3 py-2 text-sm ring-offset-background placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 ${!isEditing ? "bg-secondary/20" : ""}`}
                />
              </div>
