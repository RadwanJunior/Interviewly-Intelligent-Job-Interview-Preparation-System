  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-white via-secondary/10 to-white">
      <Helmet>
        ...
        <meta name="description" content="Practice with personalized interview questions based on your resume and dream job. Get instant feedback to improve your performance." />
      </Helmet>
      ...
      <section className="pt-32 pb-20 px-4 relative">
        ...
        <div className="container mx-auto text-center">
          ...
          <h1 className="text-4xl md:text-6xl font-heading font-bold text-foreground mb-6 animate-fade-up" style={{ animationDelay: "0.1s" }}>
            Master Your Interviews with AI
          </h1>
          <p className="text-lg md:text-xl text-foreground/70 max-w-2xl mx-auto mb-8 animate-fade-up" style={{ animationDelay: "0.2s" }}>
            Practice with personalized interview questions based on your resume and dream job. Get instant feedback to improve your performance.
          </p>
          <button className="inline-flex items-center px-8 py-3 bg-gradient-to-r from-primary to-primary/90 text-white rounded-full hover:bg-primary/90 transition-all transform hover:scale-105 animate-fade-up shadow-lg shadow-primary/25" style={{ animationDelay: "0.3s" }}>
            Start Practicing
      ...
      {/* Features Section */}
      <section className="py-20 bg-gradient-to-b from-primary/20 via-primary/10 to-secondary/10" id="features">
          ...
          <div className="bg-gradient-to-br from-primary via-primary/95 to-primary/90 rounded-3xl p-12 text-center shadow-xl relative overflow-hidden">
            ...
            <div className="max-w-2xl mx-auto relative z-10">
              ...
              <p className="text-white/90 text-lg mb-8">
                Join thousands of successful candidates who have mastered their interview skills with Interviewly.
              </p>
