import { ArrowRight, Upload, Video, MessageSquare, Award, CheckCircle2 } from "lucide-react";
  ...
  const howItWorksSteps = [
    {
      ...
      description: 'Submit your resume and the job description you\'re applying for.',
    },
    {
      number: '02',
      title: 'Receive Tailored Questions',
      description: 'Our AI analyzes both documents to generate relevant interview questions.',
    },
    {
      number: '03',
    ...
    },
    {
      ...
      description: 'Receive AI-powered analysis and suggestions to improve your performance.',
    },
  ];
        ...
        <div className="container px-6 md:px-12 mx-auto">
          ...
          <div className="text-center max-w-3xl mx-auto mb-16 opacity-0 animate-fade-in">
            ...
            <p className="text-lg text-muted-foreground">
              Follow these four simple steps to improve your interview performance.
            </p>
          </div>
        ...
        <div className="container px-4 md:px-6 mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            {pricingPlans.map((plan, index) => (
              <div 
                key={index} 
                className={`bg-white border ${plan.popular ? 'border-primary' : 'border-border'} rounded-xl p-8 shadow-lg hover:shadow-xl opacity-0 animate-fade-in delay-${index * 100}`}
              >
                ...
                <ul className="space-y-3 mb-8">
                  {plan.features.map((feature, i) => (
                    <li key={i} className="flex items-start">
                      <CheckCircle2 className={`h-5 w-5 ${plan.popular ? 'text-primary' : 'text-muted-foreground'} mr-2 mt-0.5`} />
